...
test_gitlab_merged_results_auto_merge_attended
test_gitlab_url_resolves_and_merges
transcript happy-merged-results refs/merge-requests/7/merge "$MR_TARGET_HEAD" "$MR_HEAD"
transcript stale-target refs/merge-requests/7/merge "$MR_OLD_TARGET_HEAD" "$MR_HEAD"
transcript wrong-mr-parent refs/merge-requests/7/merge "$MR_TARGET_HEAD" "$MR_WRONG_HEAD"
transcript api-fails refs/merge-requests/7/merge "$MR_TARGET_HEAD" "$MR_HEAD" glab-api-fails
transcript other-mr-merge-ref refs/merge-requests/8/merge "$MR_TARGET_HEAD" "$MR_HEAD"
transcript branch-ref refs/heads/main "$MR_TARGET_HEAD" "$MR_HEAD"
